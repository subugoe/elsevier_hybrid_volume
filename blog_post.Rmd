...
description: Publishers rarely share to whom they sent the invoice for an open access publication fee, or if it was waived. As an remarkable exception, the publisher Elsevier provides machine-readable data about open access funding. This blog post demonstrates how to mine this data with R. Analysing 70,000 hybrid open access articles published in around 1,800 Elsevier journals between 2015 and now reveals a growth of centrally covered publication fees. Nevertheless, the majority of funding sources remains unknown, raising important questions about the transparency of fee-based open access publishing.
date: Aug 29, 2019
author:
  - name: Najko Jahn 
